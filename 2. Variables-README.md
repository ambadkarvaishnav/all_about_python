...
first-name = "Vaishnavi"   # Cannot use hyphens
@name = "Vaish"        # Cannot use special characters
```
...
print(name)  # Output: Vaish
print(Name)  # Output: Roy
```
...
```python
@name = "qwerty"  # SyntaxError: invalid syntax
```
